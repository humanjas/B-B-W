...
public class DatabaseHandlerUnitTest {
    ...
    public void addBlock2() {
        Block newBlock = new Block(owner,  ownHash, previousHashChain, previousHashSender, publicKey, iban, !isRevoked);
        databaseHandler.addBlock(_block);
    ...
    public void getLatestSeqNum() {
        ...
        Block block2 = new Block(owner, ownHash, previousHashChain, previousHashSender, publicKey, iban, isRevoked);
        databaseHandler.addBlock(_block);
    ...
    public void getLatestBlock() {
        ...
        databaseHandler.addBlock(_block);
        databaseHandler.addBlock(block2);
        Block expectBlock = new Block(owner, ownHash, previousHashChain, previousHashSender, publicKey, iban, isRevoked);
    ...
    public void getAllBlocks() {
        ...
        Block block2 = new Block(owner2, ownHash, previousHashChain, previousHashSender, publicKey, iban, isRevoked);
        databaseHandler.addBlock(_block);
        databaseHandler.addBlock(block2);
