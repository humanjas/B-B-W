...
public class DatabaseHandlerUnitTest {
    ...
    public void addBlock2() {
        Block newBlock = BlockFactory.getBlock("REVOKE", owner, ownHash,
                previousHashChain, previousHashSender, publicKey, iban);
        databaseHandler.addBlock(_block);
    ...
    public void getLatestSeqNum() {
        ...
        Block block2 = BlockFactory.getBlock(blockType, owner, ownHash,
                previousHashChain, previousHashSender, publicKey, iban);
        databaseHandler.addBlock(_block);
    ...
    public void getLatestBlock() {
        Block block2 = BlockFactory.getBlock(blockType, "owner2", ownHash,
                previousHashChain, previousHashSender, publicKey, iban);
        databaseHandler.addBlock(_block);
        databaseHandler.addBlock(block2);
        Block expectBlock = BlockFactory.getBlock(blockType, "owner2", ownHash,
                previousHashChain, previousHashSender, publicKey, iban);
    ...
    public void getBlockAfter() {
        ...
        databaseHandler.addBlock(_block);
        databaseHandler.addBlock(block2);
        Block expectBlock = BlockFactory.getBlock(blockType, owner, ownHash,
                previousHashChain, previousHashSender, publicKey, iban);
