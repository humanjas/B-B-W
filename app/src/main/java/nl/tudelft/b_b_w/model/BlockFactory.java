...
public class BlockFactory {
     ...
     * @param _sequenceNumber     sequence number of block
     ...
     */
    public static Block getBlock(String type, String _owner, int _sequenceNumber, String _ownHash, String _previousHashChain, String _previousHashSender, String _publicKey, String _iban, int _trustValue) throws IllegalArgumentException {
        switch (type) {
            case "BLOCK":
                return new Block(_owner, _sequenceNumber, _ownHash, _previousHashChain, _previousHashSender, _publicKey, _iban, _trustValue, !TYPE_REVOKE);
            case "REVOKE":
                return new Block(_owner, _sequenceNumber, _ownHash, _previousHashChain, _previousHashSender, _publicKey, _iban, _trustValue, TYPE_REVOKE);
            default:
